...
class Disassembler:
    ...
    def disassemble_file(self, file_contents: str):
        ...
        self.initial_state, self.registers = self.generate_initial_state(declaration_tokens)
    ...
    def generate_initial_state(self, declaration_tokens: List[DECLARATION_TOKEN]) -> Tuple[ProgramState, List[str]]:
